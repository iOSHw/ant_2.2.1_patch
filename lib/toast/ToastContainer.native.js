...
var ToastContainerStyles = _reactNative.StyleSheet.create(_index2['default']); // tslint:disable:jsx-no-multiline-js
...
var ToastContainer = function (_React$Component) {
    ...
    (0, _createClass3['default'])(ToastContainer, [{
        ...
        value: function render() {
            ...
            var iconDom = null;
            if (type === 'loading') {
                iconDom = _react2['default'].createElement(_reactNative.ActivityIndicator, { animating: true, style: [styles.centering], color: 'black', size: 'large' });
            } else if (type === 'info') {
                iconDom = null;
            } else {
            ...
            return _react2['default'].createElement(
                ...
                _react2['default'].createElement(
                    ...
                    _react2['default'].createElement(
                        ...
                        _react2['default'].createElement(
                            _reactNative.View,
                            { style: [styles.innerWrap, iconDom ? styles.iconToast : styles.textToast,{backgroundColor:type == 'loading'?'transparent':variables.toast_fill}] },
                            iconDom,
                            _react2['default'].createElement(
                                _reactNative.Text,
